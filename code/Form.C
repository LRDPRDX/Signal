...
void Form()
{
    ...
    */
    ...
    Signal_final_2->SetParNames("A","#alpha","RC","#tau_{1}","#tau_{2}","x_{0}","gaus-C","gaus-mean","#sigma_{g}");    
    Signal_final_2->SetParameter(0,A);
    Signal_final_2->SetParameter(1,alpha);
    Signal_final_2->SetParLimits(1,0.0,1.0);
    Signal_final_2->SetParameter(2,R_C);
    //Signal_final_2->FixParameter(2,R_C);
